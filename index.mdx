...
Protoface works with any stack through the REST API, but the LiveKit Agents
plugin is the fastest way to get started. The [Quickstart](/quickstart) walks
through a complete, runnable agent in a few minutes.
