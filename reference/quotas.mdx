...
*Uncapped means no artificial cap on simultaneous sessions. To prevent
abuse, session starts are ramp rate-limited (see create rate limit
below); this affects ramp-up speed only, not your total concurrency
budget. Ramp and system technical limits still apply, and uncapped does
not imply guaranteed concurrency. If production frequently hits ramp
limits, [contact us](https://protoface.com/enterprise) to discuss higher
ramp limits.
