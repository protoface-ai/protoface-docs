...
- `pricing`: the current pricing contract.
...
Use the returned operation contract to build the request. Models can differ in
duration, quality, aspect ratio, and supported reference media.
...
If a model is unavailable or the request falls outside its contract, the API
...
<Columns cols={2}>
  ...
  <Card title="Runs" href="/guides/runs" icon="list-checks">
    Monitor and retrieve asynchronous work.
  </Card>
</Columns>
