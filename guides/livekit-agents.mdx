...
---
Use `livekit-plugins-protoface` when your voice agent runs on LiveKit Agents.
The plugin starts a Protoface session, joins the avatar to the room, and routes
agent audio to the avatar.
