...
```json
{
  ...
  "credits": { "pricing_version": "model-2026-08-15", "reserved": 8, "charged": 8 },
  "error": null,
  "metadata": {},
  "external_id": null,
...
`0`. Canceling after it starts charges the reserved amount. A finished
run returns `409` with `error.code: "run.not_cancelable"`.
