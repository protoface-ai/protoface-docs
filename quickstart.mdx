...
---
Use this quickstart to run a LiveKit Agents app with a Protoface avatar. The
sample uses Gemini Realtime; the same avatar flow applies to agents that use
...
Keep `PROTOFACE_API_KEY` and `LIVEKIT_API_SECRET` server-side.
...
<Columns cols={3}>
  ...
  <Card title="Known limitations" href="/reference/known-limitations" icon="circle-alert">
